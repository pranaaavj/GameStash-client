...
export const AddressLoading = () => {
  return (
    <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-3 p-4 sm:p-6'>
      {Array.from({ length: 3 }).map((_, i) => (
        <Card
          key={i}
          className='bg-primary-bg/30 border border-none text-primary-text shadow-md rounded-xl animate-pulse'>
